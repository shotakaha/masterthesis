...
# -*- coding: utf-8 -*-
#
# MizucheMT documentation build configuration file, created by
...
htmlhelp_basename = 'MizucheMTdoc'
...
latex_documents = [
  (master_doc,
   'MizucheMT.tex',
   # r'修士論文\\ニュートリノ反応数測定のための\\小型水チェレンコフ検出器\\"Mizuche"の開発',
   r'小型水チェレンコフ検出器Mizucheの開発',
...
man_pages = [
    (master_doc, 'mizuchemt', 'MizucheMT Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'MizucheMT', 'MizucheMT Documentation',
   author, 'MizucheMT', 'One line description of project.',
   'Miscellaneous'),
]
