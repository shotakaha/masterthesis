...
1931年に\replaced[id=st, comment="名前も追加する"]{W. Pauli}{Pauli}によってその存在が仮定され、
1935年に\replaced[id=st, comment="名前も追加する"]{E. Fermi}{Fermi}によって理論付けられた粒子である。
1935年に\tcbox[on line, size=tight]{\colorbox{Black!20}{人名} E. Fermi}によって理論付けられた粒子である。
弱い相互作用しかしないため、ニュートリノを直接検出することは非常に困難だが、
1956年に\replaced[id=st]{F. Reines}{Reines}と\replaced[id=st]{C. Cowan}{Cowan}による実験によってその存在が初めて確認された。
